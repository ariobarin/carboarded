...
# Best PPO training command (247.26 reward on Wavy V2 -- ALL-TIME BEST)
...
*Validated with `validate.py --episodes 100 --deterministic` on 2026-01-30. See `Learnings/Validation Results.md` for details.*
...
See `Learnings/Overnight Experiment Results.md` for the comprehensive LR/entropy sweep (15 experiments).
